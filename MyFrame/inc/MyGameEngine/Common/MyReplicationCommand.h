#ifndef MyReplicationCommand_H
#define MyReplicationCommand_H
...
struct MyReplicationCommand
{
public:

    MyReplicationCommand() {}
    MyReplicationCommand( uint32_t inInitialDirtyState ) : mAction( RA_Create ), mDirtyState( inInitialDirtyState ) {}
...
inline void	 MyReplicationCommand::ClearDirtyState( uint32_t inStateToClear )
{
